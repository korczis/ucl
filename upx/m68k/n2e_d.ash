...
;   note: must preserve d4 and a5-a6
...
;
; Notes:
;   we have max_match = 65535, so we can use word arithmethics on d2
;   we have max_offset < 2**23, so we can use partial word arithmethics on d1
;
